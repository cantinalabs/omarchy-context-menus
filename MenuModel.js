// Vendored verbatim from Omarchy's own menu plugin
// ($OMARCHY_PATH/shell/plugins/menu/MenuModel.js, MIT). Kept byte-identical
// below this header so a `diff` against the shipped file stays empty: this
// plugin reads the same omarchy-menu.jsonc sources through the same parser,
// and the two must never disagree about what the menu contains.
